...
namespace registrationLogin.Controllers
{
    public class OrdersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,coffee,espresso,chocoloate,frappucino,shakes,tea,bottlesAndCans,breakfast,lunch,bakery,snacksAndSweets,beans,capsules")] Order order)
        {
            if (ModelState.IsValid)
            {
